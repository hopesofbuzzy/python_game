...
BACKGROUND_MUSIC = "res/sfx/lose_1.wav"
...
LOSE_NAME = "Монстры съели ферму!(("
LOSE_NAME_POSITION = Vector2(0, 50)
LOSE_NAME_FONT_SIZE = 50
LOSE_NAME_LINESPACE = -10
STATS_TEXT_POSITION = LOSE_NAME_POSITION + Vector2(0, 200)
